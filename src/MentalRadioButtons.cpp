...
MentalRadioButtonsWidget::MentalRadioButtonsWidget(MentalRadioButtons *module) : ModuleWidget(module)
{
  ...
  {  
    ...
    addOutput(createPort<GateOutPort>(Vec(63, top_space + spacing * i), Port::OUTPUT, module, MentalRadioButtons::OUTPUT + i));
   ...
   addOutput(createPort<GateOutPort>(Vec(63, 10 + group_offset +  spacing * i), Port::OUTPUT, module, MentalRadioButtons::BUTTON2_OUT + i));
